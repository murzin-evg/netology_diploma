...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('BASKET', 'Корзина'), ('NEW', 'Новый'), ('CONFIRMED', 'Подтвержден'), ('ASSEMBLED', 'Собран'), ('SENT', 'Отправлен'), ('DELIVERED', 'Доставлен'), ('CANCELED', 'Отменен')], default='BASKET', max_length=10, verbose_name='Статус заказа')),
                ('creation_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('change_datetime', models.DateTimeField(auto_now=True, verbose_name='Дата создания')),
                ('contact', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_parameters', to='backend.contact', verbose_name='Контакт')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=True, verbose_name='Статус магазина')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('product_info', 'parameter', 'value'), name='unique_product_parameter'),
        ),
        migrations.AddConstraint(
            model_name='productinfo',
