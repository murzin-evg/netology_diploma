...
class Shop(models.Model):
    ...
    url = models.URLField(verbose_name='Ссылка', blank=True, default='')
...
class ProductInfoParameter(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['product_info', 'parameter', 'value'], name='unique_product_parameter'),
        ]
...
class Order(models.Model):
    ...
    status = models.CharField(max_length=10, verbose_name='Статус заказа', choices=STATUS_OPTIONS, default='BASKET')
    creation_datetime = models.DateTimeField(verbose_name='Дата создания', auto_now_add=True)
    change_datetime = models.DateTimeField(verbose_name='Дата создания', auto_now=True)
    ...
    def __str__(self):
        return f'{str(self.creation_datetime)} {self.status}'
